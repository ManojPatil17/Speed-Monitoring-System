class SpeedData:
    ...
    def update_speed_entry(self, zone, vehicle_id, speed):
...
class SpeedMonitorSystem:
    ...
    def issue_speeding_tickets(self, zone, speed_limit):
        tickets = {}
        zone_speeds = self.speed_data.read_speed_entries(zone)
        for vehicle_id, speed in zone_speeds.items():
